...
<section className="relative h-screen p-20 pt-20  pl-3">
  <div className=" top-[4px] right-[200px] flex flex-col items-end space-y-2"> 
  ...
  <div className="h-[10px] w-[50px] flex items-center justify-center" style={{ marginLeft: '20px', position: 'relative', top: '5px' }}>
    _______
  </div>
...
<div className="relative flex flex-col items-center mt-2">
      <div className="text-4xl font-bold" style={{ marginBottom: '-2' }}>
        Fixed
      </div>
...
<section className="mb-10">
  <div className="flex items-center mb-4">
    ...
    <div className="relative text-lg font-bold text-[#FBD784]">
      ...
      <div className="flex items-center space-x-4" style={{ position: 'relative', top: '16px' }}> 
    <div className="h-[3px] w-[90px] flex items-center justify-center" style={{ position: 'relative', left: '100px' }}>
      ROLL
    </div>
    <div className="h-[3px] w-[90px] flex items-center justify-center" style={{ position: 'relative', left: '50px' }}>
      CALL
    </div>
  </div>
    </div>
  ...
  <div className="relative mb-6 h-[10px] w-[13px] top-0 left-2">
    <h2 className="text-4xl font-bold">Setting</h2>
  </div>
