        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              for those who want to wear it to represent their respective
              countries.{" "}
            </p>
          </div>
        </section>
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              negotiate, and work towards resolutions on global challenges and
              concerns.{" "}
            </p>
          </div>
        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              wider acceptance among participants. The voting process decides
              whether the proposed amendments are adopted and incorporated into
        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              and control speaking time. By guiding conversations, they ensure
              order and efficiency, helping groups make informed choices in
              organized settings.
              <br />
              <br />
              There are several types of motions commonly used in MUN:
              <br />
              <br />
              <ol>
                <li>
                  <b>1. Motion to Open Debate:</b>
                  <br />
                  At the beginning of the committee session, the first motion
                  made is typically to open the debate on the agenda topics.
                  This motion is usually passed unanimously or without much
                  opposition, and it signals the start of discussions,
                </li>
                <br />

                <li>
                  <b>2. Motion to Set the Agenda:</b>
                  <br />
                  After the debate is open, delegates may propose motions to
                  determine the order in which the topics will be discussed.
                  This motion allows delegates to prioritize the most pressing
                  issues or contentious topics first,
                </li>
                <br />

                <li>
                  <b>3. Motion for Moderated Caucus:</b>
                  <br />
                  During a moderated caucus, the committee is temporarily
                  adjourned, and the debate is structured with a specific
                  speaking time allotted to each delegate. A motion for a
                  moderated caucus is made to discuss a specific topic or issue
                  in-depth,
                </li>
                <br />

                <li>
                  <b>4. Motion for an Unmoderated Caucus:</b>
                  <br />
                  An unmoderated caucus is a less formal session where delegates
                  can move around the room and interact more freely with each
                  other to collaborate, draft resolutions, or form alliances,
                </li>
                <br />

                <li>
                  <b>5. Motion to Enter Voting Procedure:</b>
                  <br />
                  When delegates believe that sufficient debate and discussion
                  have taken place, they may propose a motion to enter the
                  voting procedure. This motion requires a specific threshold of
                  support to pass, indicating that the committee is ready to
                  vote on a resolution,
                </li>
                <br />

                <li>
                  <b>6. Motion to Close Debate:</b>
                  <br />
                  If the committee feels that they have adequately discussed a
                  topic and are ready to move on or conclude the debate on a
                  specific issue, a motion to close the debate can be made,
                </li>
                <br />

                <li>
                  <b>7. Motion to Adjourn the Committee:</b>
                  <br />
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              <ol>
                ...
                <li>2. Chits are submitted to the Chair for approval,</li>
                <br />

                <li>
                  3. Approved chits are forwarded by the Chair to the intended
                  delegate,
                </li>
                <br />

                <li>
                  4. Delegates engage in unmoderated discussions on indicated
                  topics,
                </li>
                <br />

                <li>
                  5. Discussions aim to facilitate collaboration, planning, and
                  alliances.
                </li>
                <br />
              </ol>
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              <ol>
                ...
                <li>
                  <b>2. Yield to another delegate:</b>
                  <br />
                  It means you give up the rest of your time to another
                  delegate.
                </li>
                <br />
        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              order, faimess, and efficiency in the debate and decision-making
              process. There are mainly 3 types of Points raised during a
              discussion.
              <br />
              <br />
              <ol>
                <li>
                  <b>1. Point of Inquiry</b>
                  <br />
                  <br />
                ...
                <li>
                  <b>2. Point of Personal Privilege:</b>
                  <br />
                  <br />
                ...
                <li>
                  <b>3. Point of Order:</b>
                  <br />
                  <br />
                  It is used when a delegate believes that there was a mistake
                  made regarding the rules of procedure. It is also called the
        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              or issues. The purpose of a caucus is to encourage collaboration,
              negotiation, and the drafting of solutions or resolutions. <br />
              <br />
              <ol>
                <li>
                  <b>1. Moderated Caucus:</b>
                  <br />
                  <br />A debate format that allows delegates to make short
                  comments on a specific sub-issue. Typically, delegates who are
                  interested in speaking will raise their placards and the
                  Chairs will call on delegates to speak one at a time. In order
                  to move into a moderated caucus, the motion must include the
                ...
                <li>
                  <b>2. Unmoderated Caucus</b>
                  <br />
                  <br />A debate format in which delegates can leave their seats
                  to go and talk to others freely and informally. This is
                  usually when delegates find allies and work on draft
                  resolutions. In order to move into an unmoderated caucus, the
                  motion must include the overall caucus time and preferably the
                  purpose of the unmoderated caucus. It is also called an
                  Informal Caucus.
                </li>
                <br />
              </ol>
              Example: Delegate of Australia moves for an unmoderated caucus for
        ...
        <section className="mb-5 sm:mb-10 sm:flex gap-5 p-1 md:px-4">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              and gives you maximum points. Keep reading to know all about a
              Resolution: <br />
              <br />
              <ol>
                <li>
                  ...
                  <br />
                  <br />
                  Working papers are just a list of ideas formed by the blocs.
                  They may or may not be written in resolution format. The
                  working paper needs to be approved by the chairs.
                </li>
                <br />

                <li>
                  <b>2. Draft Resolution:</b>
                  <br />
                  <br />A document written in resolution format, approved by the
                  chairs, and introduced to the committee but not yet voted upon
                  is called a draft resolution. Delegates will be spending most
                  of their time writing and amending the draft resolutions. Once
                  a draft resolution is passed by a committee, then it becomes a
                  Resolution.
                </li>
                <br />
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Delegates who authored the draft resolution or actively
                  contributed ideas. They support the draft resolution and want
                  to see it get passed, so they should vote for it. All
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Delegates who wish the see the draft resolution debated but
                  may or may not agree with all of the ideas. However, they
                  think there is some merit to it and want to see it presented.
                  Some resolutions will require a minimum number of signatories.
                </li>
                <br />

                <li>
                  <b>5. Pre-ambulatory clauses:</b>
                  <br />
                  <br />
                  Statements in the first section of the draft resolution
                  describes the problems that the committee wants to solve as
                  well as previous measures taken to combat the problem.
                  Pre-ambulatory clauses are usually italicized or underlined by
                  not numbered.
                </li>
                <br />

                <li>
                  <b>6. Operative clauses:</b>
                  <br />
                  <br />
                  Statements in the second section of the draft resolution
                  outlines the specific solutions the sponsors wish to
                  implement. Operative clauses are usually numbered and
                  underlined.
                </li>
                <br />
                ...
                <li>
                  <b>7. Amendment</b>
                  <br />
                  <br />A change made to an operative clause of a draft
                  resolution. Amendments can add, delete, or change an operative
                  clause in a draft resolution. A Friendly Amendment is an
                  amendment written and approved by all the sponsors to a draft
                  resolution and is automatically included in the text. An
                  Unfriendly Amendment is an amendment not approved by all the
                  sponsors to their draft resolution and must be voted upon
                  before it can be included in the text.
                </li>
                <br />
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Combining two or more draft resolutions to make a bigger or
        ...
        <div className="sm:hidden mb-2 sm:mb-4 text-right">
          ...
          <div className="mt-2 sm:mt-10 max-h-[40vh] lg:w-[1200px] p-5 sm:p-10 overflow-y-scroll bg-[#0F121C]">
            <p className="text-2xl text-white mb-4">
              ...
              General Assembly <br />
              <br />
              Sponsors: United States, Austria, and Italy <br />
              <br />
              ...
              citizens, Reaffirming its Resolution 33/1996 of 25 July 1996,
              which encourages Governments to work with UN bodies aimed at
              ...
              bodies and nongovernmental organizations, <br />
              <br />
              ...
              <br />
              <br />
              This resolution aims to strengthen the coordination of
              humanitarian assistance in complex emergencies, acknowledging the
              importance of collaboration, rapid response, and unbiased
              information sharing. The General Assembly affirms its commitment
              to addressing global crises with effective measures
              <br />
              <br />
              <br />
              *End of Resolution*
