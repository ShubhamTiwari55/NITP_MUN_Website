    ...
    <div className="relative w-full h-[90vh] bg-cover bg-center" style={{ backgroundImage: `url('/bg2.png')` }}>
      <div className="absolute top-0 left-0 w-full h-full flex flex-col md:flex-row items-center justify-evenly z-10">
        ...
        <div className="text-center flex flex-col align-center justify-items-center">
          ...
          <h1 className="text-[10vw] md:text-[5vw] font-extrabold text-[#FBD784] flex flex-row items-center justify-center">
            <Image width={170} height={3000} src="/rect.png" alt="logo" className="" />
            RULE
          </h1>
          <h1 className="text-[10vw] md:text-[8vw] font-extrabold sm:mt-[-5%] md:mt-[-10%] lg:mt-[-12%] text-[#FBD784]">BOOK</h1>
